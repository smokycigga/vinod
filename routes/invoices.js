...
router.post('/', async (req, res) => {
    try {
        const {
            invoiceDate, customerId, billingCompanyId, deptCode, poId,
...
router.post('/:id/approve', async (req, res) => {
    ...
    try {
        ...
        const filename = `Invoice-${invoice.invoiceNumber}-SIGNED-${Date.now()}.pdf`;
